  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 120;
          Label4: while (true) {
          if (!(i_654311664 < n_301990077)) break Label4;
            F.line = 49;
            iHEX60gensym4_301990092 = i_654311664;
            F.line = 49;
            ...
            F.line = 122;
            i_654311664 = addInt(i_654311664, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556512(f_33556513) {
  var result_33556514 = [[]];
    ...
    Label5: {
      var j_33556558 = 0;
      var colontmp__654311656 = 0;
      colontmp__654311656 = (i_33556523 - 1);
      var res_654311658 = colontmp__654311656;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_654311658)) break Label7;
            j_33556558 = res_654311658;
...
function HEX3DHEX3D_654311437(x_654311439, y_654311440) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      var i_654311463 = 0;
      F.line = 75;
      var colontmp__654311649 = 0;
      F.line = 333;
      colontmp__654311649 = subInt((x_654311439).length, 1);
      F.line = 90;
      var res_654311651 = 0;
      Label2: {
        F.line = 91;
          Label3: while (true) {
          if (!(res_654311651 <= colontmp__654311649)) break Label3;
            F.line = 333;
            i_654311463 = res_654311651;
...
function HEX3DHEX3D_654311495(x_654311497, y_654311498) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      var i_654311521 = 0;
      F.line = 75;
      var colontmp__654311669 = 0;
      F.line = 333;
      colontmp__654311669 = subInt((x_654311497).length, 1);
      F.line = 90;
      var res_654311670 = 0;
      Label2: {
        F.line = 91;
          Label3: while (true) {
          if (!(res_654311670 <= colontmp__654311669)) break Label3;
            F.line = 333;
            i_654311521 = res_654311670;
            ...
            F.line = 93;
            res_654311670 = addInt(res_654311670, 1);
          }
      };
    };
    F.line = 337;
...
F.line = 119;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(8, 3) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(0, 3, 4) == @[\'d\', \'b\', \'c\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D_654311437(new Uint8Array([97, 98, 99, 100, 101]).copyWithin(1, 3), [97, 100, 101, 100, 101]))) {
F.line = 119;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(9, 3) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(1, 3) == @[\'a\', \'d\', \'e\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D_654311495(new Int32Array([1, 2, 3, 4, 5]).copyWithin(-2), [1, 2, 3, 1, 2]))) {
F.line = 119;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(10, 3) `[1, 2, 3, 4, 5].copyWithin(-2) == @[1, 2, 3, 1, 2]` "));
}

if (!(HEX3DHEX3D_654311495(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3), [4, 5, 3, 4, 5]))) {
F.line = 119;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(11, 3) `[1, 2, 3, 4, 5].copyWithin(0, 3) == @[4, 5, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D_654311495(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3, 4), [4, 2, 3, 4, 5]))) {
F.line = 119;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(12, 3) `[1, 2, 3, 4, 5].copyWithin(0, 3, 4) == @[4, 2, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D_654311495(new Int32Array([1, 2, 3, 4, 5]).copyWithin(-2, -3, -1), [1, 2, 3, 3, 4]))) {
F.line = 119;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(13, 3) `[1, 2, 3, 4, 5].copyWithin(-2, -3, -1) == @[1, 2, 3, 3, 4]` "));
}
...
F.line = 131;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_2.nim(9, 3) `arrai.shift() == 1` "));
}

if (!(HEX3DHEX3D_654311495(arrai_687865862[0], [2, 3]))) {
F.line = 131;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_2.nim(10, 3) `arrai == @[2, 3]` "));
}

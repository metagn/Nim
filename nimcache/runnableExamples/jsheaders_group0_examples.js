  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 120;
          Label4: while (true) {
          if (!(i_654311669 < n_301990077)) break Label4;
            F.line = 49;
            iHEX60gensym4_301990092 = i_654311669;
            F.line = 49;
            ...
            F.line = 122;
            i_654311669 = addInt(i_654311669, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556512(f_33556513) {
  var result_33556514 = [[]];
    ...
    Label5: {
      var j_33556558 = 0;
      var colontmp__654311661 = 0;
      colontmp__654311661 = (i_33556523 - 1);
      var res_654311663 = colontmp__654311661;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_654311663)) break Label7;
            j_33556558 = res_654311663;
...
function HEX3DHEX3D_654311436(x_654311438, y_654311439) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      var i_654311462 = 0;
      F.line = 75;
      var colontmp__654311674 = 0;
      F.line = 333;
      colontmp__654311674 = subInt((x_654311438).length, 1);
      F.line = 90;
      var res_654311676 = 0;
      Label2: {
        F.line = 91;
          Label3: while (true) {
          if (!(res_654311676 <= colontmp__654311674)) break Label3;
            F.line = 333;
            i_654311462 = res_654311676;
            ...
            F.line = 93;
            res_654311676 = addInt(res_654311676, 1);
          }
      };
    };
    F.line = 337;
...
function HEX3DHEX3D_654311495(x_654311497, y_654311498) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      var i_654311521 = 0;
      F.line = 75;
      var colontmp__654311679 = 0;
      F.line = 333;
      colontmp__654311679 = subInt((x_654311497).length, 1);
      F.line = 90;
      var res_654311680 = 0;
      Label2: {
        F.line = 91;
          Label3: while (true) {
          if (!(res_654311680 <= colontmp__654311679)) break Label3;
            F.line = 333;
            i_654311521 = res_654311680;
            ...
            F.line = 93;
            res_654311680 = addInt(res_654311680, 1);
          }
      };
    };
    F.line = 337;
...
Label1: {
  ...
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(12, 5) `header.hasKey(\"key\")` "));
  }
  
  if (!(HEX3DHEX3D_654311436(Array.from(header_654311426.keys()), ["key"]))) {
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(13, 5) `header.keys() == @[\"key\".cstring]` "));
  }
  
  if (!(HEX3DHEX3D_654311436(Array.from(header_654311426.values()), ["value"]))) {
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(14, 5) `header.values() == @[\"value\".cstring]` "));
  }
  
  if (!((header_654311426.get("key") == "value"))) {
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(15, 5) `header[\"key\"] == \"value\".cstring` "));
  }
  ...
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(17, 5) `header[\"other\"] == \"another\".cstring` "));
  }
  
  if (!(HEX3DHEX3D_654311495(Array.from(header_654311426.entries()), [{Field0: "key", Field1: "value"}, {Field0: "other", Field1: "another"}]))) {
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(18, 5) `header.entries() ==\x0A    @[(\"key\".cstring, \"value\".cstring), (\"other\".cstring, \"another\".cstring)]` "));
  }
  
  if (!((JSON.stringify(Array.from(header_654311426.entries())) == "[[\"key\",\"value\"],[\"other\",\"another\"]]"))) {
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(19, 5) `header.toCstring() == \"\"\"[[\"key\",\"value\"],[\"other\",\"another\"]]\"\"\".cstring` "));
  }
  ...
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(21, 5) `header.entries() == @[(\"key\".cstring, \"value\".cstring)]` "));
  }
  ...
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(23, 5) `header.entries() == @[]` "));
  }
  
  if (!((Array.from(header_654311426.entries()).length == 0))) {
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(24, 5) `header.len == 0` "));
  }
...
Label2: {
  ...
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(31, 5) `header[\"key\"] == \"a, b, c\".cstring` "));
  }
  ...
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(33, 5) `header[\"key\"] == \"value\".cstring` "));
  }
...
Label3: {
  ...
  F.line = 51;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(39, 5) `header[\"key\"] == \"b\".cstring` "));
  }

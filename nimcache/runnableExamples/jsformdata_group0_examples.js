  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 120;
          Label4: while (true) {
          if (!(i_654311476 < n_301990077)) break Label4;
            F.line = 49;
            iHEX60gensym4_301990092 = i_654311476;
            F.line = 49;
            ...
            F.line = 122;
            i_654311476 = addInt(i_654311476, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556512(f_33556513) {
  var result_33556514 = [[]];
    ...
    Label5: {
      var j_33556558 = 0;
      var colontmp__654311468 = 0;
      colontmp__654311468 = (i_33556523 - 1);
      var res_654311470 = colontmp__654311468;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_654311470)) break Label7;
            j_33556558 = res_654311470;
...
F.line = 61;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(12, 3) `data.hasKey(\"key0\")` "));
}

if (!((data_654311426.get("key0") == "value0"))) {
F.line = 61;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(13, 3) `data[\"key0\"] == \"value0\".cstring` "));
}
...
F.line = 61;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(15, 3) `data.len == 0` "));
}

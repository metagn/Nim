  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 120;
          Label4: while (true) {
          if (!(i_654311453 < n_301990077)) break Label4;
            F.line = 49;
            iHEX60gensym4_301990092 = i_654311453;
            F.line = 49;
...
F.line = 56;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_1.nim(9, 3) `jsregex in r\"abc\"` "));
}

if (!(!(contains_671088691("abcd", jsregex_654311426)))) {
F.line = 56;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_1.nim(10, 3) `jsregex notin r\"abcd\"` "));
}

if (!(contains_671088691("xabc", jsregex_654311426))) {
F.line = 56;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_1.nim(11, 3) `\"xabc\".contains jsregex` "));
}
...
F.line = 65;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_2.nim(9, 3) `\"abcd\".startsWith jsregex` "));
}
...
if (!(endsWith_671088712("abcd", jsregex_704643074))) {
F.line = 72;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_3.nim(9, 3) `\"abcd\".endsWith jsregex` "));
}
...
function HEX3DHEX3D_721420300(x_721420302, y_721420303) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      var i_721420326 = 0;
      F.line = 75;
      var colontmp__721420453 = 0;
      F.line = 333;
      colontmp__721420453 = subInt((x_721420302).length, 1);
      F.line = 90;
      var res_721420455 = 0;
      Label2: {
        F.line = 91;
          Label3: while (true) {
          if (!(res_721420455 <= colontmp__721420453)) break Label3;
            F.line = 333;
            i_721420326 = res_721420455;
            ...
            F.line = 93;
            res_721420455 = addInt(res_721420455, 1);
          }
      };
    };
    F.line = 337;
...
F.line = 78;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(10, 3) `\"nim javascript\".contains jsregex` "));
}

if (!(HEX3DHEX3D_721420300((jsregex_721420290.exec("nim javascript") || []), ["nim"]))) {
F.line = 78;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(11, 3) `jsregex.exec(r\"nim javascript\") == @[\"nim\".cstring]` "));
}

if (!((jsregex_721420290.toString() == "/\\w+/i"))) {
F.line = 78;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(12, 3) `jsregex.toCstring() == r\"/\\w+/i\"` "));
}
...
F.line = 78;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(14, 3) `\"0123456789abcd\".contains jsregex` "));
}

if (!(eqStrings(HEX24_671088688(jsregex_721420290), [47,91,48,45,57,93,47,105]))) {
F.line = 78;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(15, 3) `$jsregex == \"/[0-9]/i\"` "));
}
...
F.line = 78;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(17, 3) `\"abcd\".startsWith jsregex` "));
}

if (!(endsWith_671088712("dabc", jsregex_721420290))) {
F.line = 78;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(18, 3) `\"dabc\".endsWith jsregex` "));
}
...
F.line = 78;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(20, 3) `\"do1ne\".split(jsregex) == @[\"do\".cstring, \"ne\".cstring]` "));
}
...
F.line = 78;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(22, 3) `\"hello world\".replace(jsregex, \"X\") == \"heXlo world\"` "));
}
...
F.line = 78;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(24, 3) `\"abbcccdddd\".replace(jsregex, proc (m: varargs[cstring]): cstring =\x0A  ($m[0] & $(m.len)).cstring) ==\x0A    \"a1b2c3d4\"` "));
}
...
F.line = 78;
failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(26, 3) `\"foo\".match(digitsRegex) == @[]` "));
}

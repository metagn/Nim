  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 120;
          Label4: while (true) {
          if (!(i_654311860 < n_301990077)) break Label4;
            F.line = 49;
            iHEX60gensym4_301990092 = i_654311860;
            F.line = 49;
            ...
            F.line = 122;
            i_654311860 = addInt(i_654311860, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556512(f_33556513) {
  var result_33556514 = [[]];
    ...
    Label5: {
      var j_33556558 = 0;
      var colontmp__654311852 = 0;
      colontmp__654311852 = (i_33556523 - 1);
      var res_654311854 = colontmp__654311852;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_654311854)) break Label7;
            j_33556558 = res_654311854;
...
async function example_654311622() {
  var result_654311624 = null;
  ...
  BeforeRet: {
    F.line = 119;
    var response_654311634 = (await doFetch_654311593());
    if (!(response_654311634.ok)) {
    F.line = 119;
    failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(76, 9) `response.ok` "));
    }
    
    if (!((response_654311634.status == 200))) {
    F.line = 119;
    failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(77, 9) `response.status == 200.cint` "));
    }
    
    if (false) {
    F.line = 119;
    failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(78, 9) `response.headers is Headers` "));
    }
    
    if (false) {
    F.line = 119;
    failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(79, 9) `response.body is cstring` "));
    }
    
    F.line = 119;
    result_654311624 = undefined;
    break BeforeRet;
  };
  framePtr = F.prev;

  return result_654311624;

}

function catch_654311797(future_654311799, onReject_654311800) {
  var result_654311801 = null;

  var F = {procname: "catch.catch", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/asyncjs.nim", line: 0};
  framePtr = F;
    F.line = 267;
    result_654311801 = future_654311799.catch(onReject_654311800)
  framePtr = F.prev;

  return result_654311801;

}

function then_654311771(future_654311774, onSuccess_654311775, onReject_654311776) {
  var result_654311777 = null;

  var F = {procname: "then.then", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/asyncjs.nim", line: 0};
  framePtr = F;
  BeforeRet: {
    F.line = 243;
    var ret_654311792 = null;
    F.line = 244;
    ret_654311792 = future_654311774.then(onSuccess_654311775, onReject_654311776)
    F.line = 245;
    result_654311777 = ret_654311792;
    break BeforeRet;
  };
  framePtr = F.prev;
...
function then_654311730(future_654311733, onSuccess_654311734, onReject_654311735) {
  var result_654311736 = null;

  var F = {procname: "then.then", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/asyncjs.nim", line: 0};
  framePtr = F;
  BeforeRet: {
    F.line = 243;
    var ret_654311766 = null;
    F.line = 244;
    ret_654311766 = future_654311733.then(onSuccess_654311734, onReject_654311735)
    F.line = 245;
    result_654311736 = ret_654311766;
    break BeforeRet;
  };
  framePtr = F.prev;

  return result_654311736;

}
async function example2_654311684() {
    
function HEX3Aanonymous_654311714(response_654311715) {
      ...
      framePtr = F;
        F.line = 86;
        result_654311716 = response_654311715.json();
      framePtr = F.prev;
...
function HEX3Aanonymous_654311768(json_654311769) {
      var F = {procname: "example2.:anonymous", prev: framePtr, filename: "/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim", line: 0};
      framePtr = F;
        F.line = 87;
        console.log(json_654311769);
      framePtr = F.prev;

      
    }
    
function HEX3Aanonymous_654311794(err_654311795) {
      var F = {procname: "example2.:anonymous", prev: framePtr, filename: "/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim", line: 0};
      framePtr = F;
        F.line = 119;
        console.log("Request Failed", err_654311795);
      framePtr = F.prev;

      
    }

  var result_654311686 = null;
  ...
  BeforeRet: {
    F.line = 119;
    (await catch_654311797(then_654311771(then_654311730(fetch("https://api.github.com/users/torvalds"), HEX3Aanonymous_654311714, null), HEX3Aanonymous_654311768, null), HEX3Aanonymous_654311794));
    F.line = 119;
    result_654311686 = undefined;
    break BeforeRet;
  };
  framePtr = F.prev;

  return result_654311686;
...
Label1: {
  ...
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(27, 5) `options0.keepalive == false` "));
  }
  
  if (!((options0_654311433.method == "POST"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(28, 5) `options0.metod == \"POST\".cstring` "));
  }
  
  if (!((options0_654311433.body == "{\"key\": \"value\"}"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(29, 5) `options0.body == \"\"\"{\"key\": \"value\"}\"\"\".cstring` "));
  }
  
  if (!((options0_654311433.mode == "no-cors"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(30, 5) `options0.mode == \"no-cors\".cstring` "));
  }
  
  if (!((options0_654311433.credentials == "omit"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(31, 5) `options0.credentials == \"omit\".cstring` "));
  }
  
  if (!((options0_654311433.cache == "no-cache"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(32, 5) `options0.cache == \"no-cache\".cstring` "));
  }
  
  if (!((options0_654311433.referrerPolicy == "no-referrer"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(33, 5) `options0.referrerPolicy == \"no-referrer\".cstring` "));
  }
  
  if (!((options0_654311433.redirect == "follow"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(34, 5) `options0.redirect == \"follow\".cstring` "));
  }
  
  if (!((options0_654311433.referrer == "client"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(35, 5) `options0.referrer == \"client\".cstring` "));
  }
  
  if (!((options0_654311433.integrity == ""))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(36, 5) `options0.integrity == \"\".cstring` "));
  }
  
  if (!((Array.from(options0_654311433.headers.entries()).length == 0))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(37, 5) `options0.headers.len == 0` "));
  }
...
Label2: {
  ...
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(53, 5) `options1.keepalive == false` "));
  }
  
  if (!((options1_654311489.method == "POST"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(54, 5) `options1.metod == $HttpPost` "));
  }
  
  if (!((options1_654311489.body == "{\"key\": \"value\"}"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(55, 5) `options1.body == \"\"\"{\"key\": \"value\"}\"\"\".cstring` "));
  }
  
  if (!((options1_654311489.mode == "no-cors"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(56, 5) `options1.mode == $fmNoCors` "));
  }
  
  if (!((options1_654311489.credentials == "omit"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(57, 5) `options1.credentials == $fcOmit` "));
  }
  
  if (!((options1_654311489.cache == "no-cache"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(58, 5) `options1.cache == $fchNoCache` "));
  }
  
  if (!((options1_654311489.referrerPolicy == "no-referrer"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(59, 5) `options1.referrerPolicy == $frpNoReferrer` "));
  }
  
  if (!((options1_654311489.redirect == "follow"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(60, 5) `options1.redirect == $frFollow` "));
  }
  
  if (!((options1_654311489.referrer == "client"))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(61, 5) `options1.referrer == \"client\".cstring` "));
  }
  
  if (!((options1_654311489.integrity == ""))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(62, 5) `options1.integrity == \"\".cstring` "));
  }
  
  if (!((Array.from(options1_654311489.headers.entries()).length == 0))) {
  F.line = 119;
  failedAssertImpl_268435531(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(63, 5) `options1.headers.len == 0` "));
  }
...
Label4: {
  F.line = 119;
  var _ = example_654311622();
};
Label5: {
  F.line = 119;
  var _ = example2_654311684();
};
}
